...
const Connexion = ({
  ...
  return (
    ...
    <div>
      ...
      {
      // en attente si connexion via bouton
      ...
      <div className="">
        <button
          type="button"
          className=""
          onClick={() => setopenModalConnexion(false)}
        >
          Déconnexion
        </button>
      </div>
      ...
      <div className="div-modal bg-dark modal-connexion">
        <div className="row justify-content-center">
          ...
          <form className="col-12 col-md-5 m-7  py-5 rounded  ">
            <div className="row justify-content-center">
